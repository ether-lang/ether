...
- Add support enumeration sin the language
- Improve error handling and diagnostics
- Extend the builtin functions library to shift the language away from a prototype into an actual production language
- Optimize the performance of the entire implementation (with an important focus on the VM).
